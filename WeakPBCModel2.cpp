...
const char *WeakPBCModel2::USHAPE_PROP = "ushape";
const char *WeakPBCModel2::TSHAPE_PROP = "tshape";
const char *WeakPBCModel2::ISCHEME_PROP = "ischeme";
...
template <typename T>
void WeakPBCModel2::sortBndFace_(T &bndFace, const idx_t &index)
{
